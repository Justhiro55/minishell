...
/*   Updated: 2023/11/09 18:31:19 by hhagiwar         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	set_node(t_node *node)
{
	...
	// node_child2->redirects->fd_file = open("src/pipe/pipe_utils.c",
			O_RDONLY);
			...
			node_child4->redirects->fd_file = open("src/pipe/pipe_utils2.c",
													O_RDONLY);
