...
/*   Updated: 2023/11/14 18:12:08 by hhagiwar         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	set_node(t_node *node)
{
	...
	node_child2->redirects->next->fd_file = open_file(node_child2->redirects->next);
	...
	node_child3->redirects->next->next->type = REDIRECT_INPUT;
	node_child3->redirects->next->next->filename = strdup("src/exec/set_env.c");
	node_child3->redirects->next->next->fd_file = open_file(node_child3->redirects->next->next);
